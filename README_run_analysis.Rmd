...
*Refer to CODEbook_run_analysis.Rmd for description of variables.
...
The new data D2_tidymeans contains information on the average of each of the activity feature variable for each activity and each subject.
