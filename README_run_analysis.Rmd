---
title: "README for run_analysis.R -- describing how the script works."
output:
  html_document:
    keep_md: yes
---
...
Notes regarding run_analysis.R -- coded by h-rm_tan 22-23Oct2015

#### REFs:
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
https://www.youtube.com/watch?v=XOEN9W05_4A

(i) The code should work if you have run_analysis.R and the unzipped "UCI HAR Dataset" data folder present in the working directory of R/Rstudio. Otherwise, paths need to be set, e.g.:
...
```
1.1 First the activity variable files are being read.
```{r}
## --- variables
...
##### --- 5 DERIVE Variable Means GROUPED by SubjID & Activity --------------------------------------------------------------
