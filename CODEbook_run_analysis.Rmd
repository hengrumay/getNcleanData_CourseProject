...
###### Information about the RAW DATA as provided by http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
...
- Triaxial acceleration (standard gravity unit="g") from the accelerometer (total acceleration) and the estimated body acceleration.
- Triaxial Angular velocity (unit="radians/s"") from the gyroscope. 
