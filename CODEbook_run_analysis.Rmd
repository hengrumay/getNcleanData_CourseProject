...
<br>*Refer to README_run_analysis.Rmd for details on what the script does.
...
<b>D2_tidymeans</b> is a 180 x 89 matrix summary of the means of activity feature variables in D1 which are grouped by the activity performed and by each subject (regardless of their group assignment). Each subject has 6 rows of data values; a total of 180 rows.
```{r}
